            ...
            <form action="{{ route('profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img src="{{ asset('storage/' . $user->foto_user) }}" alt="user-avatar" class="d-block rounded"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="nama_lengkap" name="nama_lengkap"
                                value="{{ $user->nama_lengkap }}" autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="email" class="form-label">Email</label>
                            <input class="form-control" type="email" name="email" id="email" name="email"
                                value="{{ $user->email }}" />
                        </div>
                        <div class="mb-3 col-md-6">
